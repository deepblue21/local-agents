        ...
        <div className="grid grid-cols-3 gap-3 max-w-[640px]">
          {THEMES.map(t => {
            ...
            const previews = {
              ...
              forest:  { bg: '#000000', surface: '#0a0a0a', accent: '#00ff00' },
              arctic:  { bg: '#ffffff', surface: '#f4f4f5', accent: '#2563eb' },
            }[t.id];
            return (
    ...
    <div className="flex-1 flex flex-col min-h-0 p-6 gap-5 overflow-hidden">
      <div className="flex items-end justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button tone="solid" size="md" icon={L.Check} onClick={() => setDirty(false)}>apply &amp; restart cluster</Button>
        </div>
      </div>
